...
def train(
    data_dir: str = "/data/", num_epochs: int = 1000, save_path: str = "/runs/baseline"
):
    pass
...
def evaluate(data_dir: str = "/data/", save_path: str = "/runs/baseline"):
    pass
